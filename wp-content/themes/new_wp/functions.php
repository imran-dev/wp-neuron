...
if ( ! function_exists( 'neuron_setup' ) ) :
	...
	function neuron_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'neuron_custom_background_args', array(
...
function neuron_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'neuron' ),
		'id'            => 'sidebar-1',
...
function neuron_scripts() {
	...
	wp_enqueue_script( 'neuron-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'neuron-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
